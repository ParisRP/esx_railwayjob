...
local trainHashes = {
    ...
    freightcar3 = -1874009509, -- Standard freight car 3
...
function SpawnTrain(modelName, vtype)
    ...
    local trainHash = trainHashes[modelName] or trainHashes.freight or trainHashes.metrotrain
    ...
    local trainType = (modelName == 'metrotrain' or vtype == 'metrotrain') and trainTypeMap.metrotrain.type or trainTypeMap.freight.type
...
function AttachWagon(wagonModel)
    ...
    local wagonHash = trainHashes[wagonModel] or trainHashes.freightcar or trainHashes.metotrain
